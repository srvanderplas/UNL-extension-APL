...
Under random chance, it appears that our tea taster would be expected to identify all of the cups correctly (corresponding to HHHH) 4/100 = 0.04 times. 
...
The full theoretical distribution for the tea tasting experiment is available [here](https://en.wikipedia.org/wiki/Lady_tasting_tea#The_experiment), but in essence, the researcher uses a theoretical distribution 
